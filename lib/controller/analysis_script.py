...
import lib.features.feature_extraction_old as feauture_extraction
...
# output_processed.to_csv(
#     r'C:\Users\phand\OneDrive\Tài liệu\XSS_detection_DoAn\Dataset\final_ds\output_raw1.csv',
#     index=False,
# )
# # # -------------------------------------------------------------------------------------------------------------------
...
# output_processed = pd.DataFrame(listVectorExtract, columns=utils.column_name)
# output_processed.to_csv(
#     r'C:\Users\phand\OneDrive\Tài liệu\XSS_detection_DoAn\Dataset\final_ds\output_raw2.csv',
#     index=False,
# )
#   -------------------------------------------------------------------------------------------------------------------
# xss_features = []
...
# label = 1
# with open(
#         r'C:\Users\phand\OneDrive\Tài liệu\XSS_detection_DoAn\Dataset\raw_dataset\XSS_dataset_payloads_raw_malicious.txt',
...
#         k += 1
#
# output_processed = pd.DataFrame(xss_features, columns=utils.column_name_sfs)
# output_processed.to_csv(
#     r'C:\Users\phand\OneDrive\Tài liệu\XSS_detection_DoAn\Dataset\final_ds\output_raw3_malicious_sfs.csv',
#     index=False,
# )
# -------------------------------------------------------------------------------------------------------------------
...
#
# fullDatasetDf = pd.concat([df3, df4])
# print(fullDatasetDf)
# fullDatasetDf.to_csv(r"C:\Users\phand\OneDrive\Tài liệu\XSS_detection_DoAn\Dataset\final_ds\output_full_old.csv", index=False)
